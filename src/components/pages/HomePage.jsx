...
export const HomePage = () => {
	return (
		<BioCard>	Raymond Enoksen has, for the past 20 years, been one of Scandinavia's most prolific composers for
			...
			Best Music at the BCN International Film Festival.</BioCard>
	)
}
